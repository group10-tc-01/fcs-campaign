...
using Fcg.Campaign.WebApi.Authentication;
using Fcg.Campaign.WebApi.Middlewares;
using Fcg.Campaign.WebApi.Observability;
...
namespace Fcg.Campaign.WebApi.DependencyInjection;
